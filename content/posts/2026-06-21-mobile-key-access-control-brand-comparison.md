...
tags:
  ...
  - PMS API
  - 邊緣運算
hero_image: /assets/2026-06-20-smart-checkin-mobile-key.svg
hero_image_alt: 手機數位鑰匙開啟飯店房門的概念圖
...
![手機數位鑰匙讓旅客不用排隊領卡，也讓房門、電梯與公共設施權限可以被系統管理](/assets/2026-06-20-smart-checkin-mobile-key.svg "Cellbedell / AI 生成概念圖")
